...
\defpage
	...
	\begin{spacing}{1.3}
		\subsection*{Snittar}
		\textit{Västerbottenssnitt med gräslökskräm och rödbetsskott \\
	...
	\begin{spacing}{1.3}
		\textit{Amerikansk ek- och hickoryrökig Oxbringa eller högrev \\ 
	...
	\end{spacing}	
		...
		\textit{Citronbavaroise med dillpulver och smetanasorbet}
		
		\subsection*{Tårta}
		\begin{spacing}{1.3}
		\textit{Chokladmousse fylld med körsbär- och vaniljpannacotta, dekorerad med chokladflarn, vaniljmaränger och jordgubbsmakroner}
		\end{spacing}
	...
	\node[inner sep=0pt] (borsplacering) at (7.6, -4.2) {\includegraphics[width=1.4\paperwidth]{Bordsplacering.jpg}} ;
	
	\node[] (Bord 1) at (-0.8,-0.6) {\large \circled{1}};
	\node[] (Bord 2) at (2.2,-0.6) {\large \circled{2}};
	\node[text=purple] at (7.7,-0.50) {\large Honnörsbordet};
	\node[] (Bord 3) at (12.2,-0.6) {\large \circled{3}};
	\node[] (Bord 4) at (14.6,-0.6) {\large \circled{4}};
	% Rad 2		
	\node[] (Bord 5) at (-0.5,-4.1) {\large \circled{5}};
	\node[] (Bord 6) at (2.4,-4.1) {\large \circled{6}};
	\node[] (Bord 7) at (10.3,-4.1) {\large \circled{7}};
	\node[] (Bord 8) at (13.3,-4.1) {\large \circled{8}};
	\node[] (Bord 9) at (15.9,-4.1) {\large \circled{9}};
	% Rad 3
	\node[] (Bord 10) at (-0.3,-7.6) {\large \circled{10}};
	\node[] (Bord 11) at (2.3,-7.6) {\large \circled{11}};
	\node[] (Bord 12) at (12.7,-7.6) {\large \circled{12}};
	\node[] (Bord 13) at (15.6,-7.6) {\large \circled{13}};
